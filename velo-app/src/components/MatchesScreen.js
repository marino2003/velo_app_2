              ...
              >
                ...
                <div className="flex space-x-3">
                  <button
                    ...
                    className="flex-1 bg-orange-600 hover:bg-orange-700 text-white py-2 px-4 rounded-xl text-sm font-medium transition-colors"
                  >
                    Stuur groet 👋
                  </button>
                  <button
                    onClick={() => setSelectedMatch(selectedMatch === match.id ? null : match.id)}
                    className="px-4 py-2 bg-slate-100 hover:bg-slate-200 text-slate-600 rounded-xl text-sm transition-colors"
                  >
